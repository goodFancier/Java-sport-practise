...
public class BinaryTreePractice
{
		...
		class BST<T>
		{
				...
				public BSTNode<T> FinMinMax(BSTNode<T> FromNode, boolean FindMax)
				{
						...
						treePostOrder(bstNodes, FromNode);
						if(FindMax)
				...
				public ArrayList<BSTNode> DeepAllNodes(Integer order)
				{
				...
				private void treePostOrder(List<BSTNode<T>> nodeList, BSTNode<T> node)
				{
						if(node == null)
								return;
						treePostOrder(nodeList, node.LeftChild);
						treePostOrder(nodeList, node.RightChild);
						nodeList.add(node);
				}

				private void postOrder(List<BSTNode> nodeList, BSTNode node)
				{
						if(node == null)
								return;
				...
				private void inOrder(ArrayList<BSTNode> nodeList, BSTNode node)
				{
						if(node == null)
								return;
				...
				private void preOrder(ArrayList<BSTNode> nodeList, BSTNode node)
				{
						if(node == null)
								return;
						nodeList.add(node);
